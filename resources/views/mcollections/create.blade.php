                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    ...
                                    <span>Please complete the request details before proceeding feather with the
                                        application</span>
                                </div>
                                <div class="card-body">

                                    <form method="POST" action="{{ url('mcollections') }}" id="form-horizontal"
                                        role="form" class="form-horizontal form-wizard-wrapper">
                                        ...
                                        <fieldset>
                                            <div class="row mb-4 mb-4">
                                                <div class="col-lg-6">
                                                    ...
                                                    <select name="paynumber" id="paynumber" class="form-control"
                                                        style="width: 100%;">
                                                        <option value="">Select requested employee paynumber</option>
                                                        @if ($requests)
                                                            @foreach ($requests as $request)
                                                                <option value="{{ $request->id }}">
                                                                    {{ $request->user->paynumber }} -
                                                                    {{ $request->user->full_name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                    @error('paynumber')
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" name="jobcard" id="jobcard" class="form-control"
                                                        readonly placeholder="select jobcard">
                                            ...
                                            <div class="row mb-4 mb-4">
                                                <div class="col-lg-6">
                                                    <label for="mrequest">Request Number *</label>
                                                    <input type="text" name="mrequest" id="mrequest"
                                                        class="form-control" placeholder="REQ112">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" name="allocation" id="allocation"
                                                        class="form-control" placeholder="244January2021">
                                            ...
                                            <div class="row mb-4 mb-4">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="date" name="issue_date" id="issue_date"
                                                        class="form-control" placeholder="02-07-21">
                                            ...
                                            <div class="row mb-4 mb-4">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text" name="mtype" id="mtype" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-check form-check-inline col-lg-3">
                                                        <input class="form-check-input" type="radio" name="iscollector"
                                                            id="inlineRadio1" value="self" checked>
                                                        <label class="form-check-label" for="inlineRadio1">Self</label>
                                                    </div>
                                                    <div class="form-check form-check-inline col-lg-3">
                                                        <input class="form-check-input" type="radio"
                                                            onchange="showDiv('hidden_div',this)" name="iscollector"
                                                ...
                                                <div class="col-lg-12">
                                                    <p class="ml-3 d-block"><strong
                                                            style="font-weight: bold; font-size:18px;">Note : </strong>
                                                        Please enter authoriser verification pin to proceed further into the
                                                        application</p>
                                                    <div>
        ...
        $(function() {
            ...
            $('#paynumber').select2({
                ...
                if (id) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "/getbeneficiary/" + id,
                        _token: _token,
                        success: function(res) {
                            if (res) {
                                $("#collected_by").empty();
                                $.each(res, function(key, value) {
                                    $("#collected_by").append('<option value="' + key +
                                        '">' + key + ' - ' + value + '</option>');
                                });
                            }
                        }
                    ...
                    $.ajax({
                        type: "get",
                        url: "/available/meat/jobcard",
                        _token: _token,
                        success: function(res) {
                            if (res) {
                                $("#jobcard").empty();
                                $.each(res, function(key, value) {
                                    $("#jobcard").val(value.card_number);
                                });
                            }
                        }
