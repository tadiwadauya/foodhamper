                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ url('fcollections') }}" id="form-horizontal"
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row mb-4 mb-4">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" readonly name="frequest" id="frequest"
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="text" readonly name="allocation" id="allocation"
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-check form-check-inline col-lg-3">
                                                        <input class="form-check-input"
                                                            onchange="showDiv('hidden_div',this)" type="radio"
                                                            name="iscollector" id="inlineRadio2" value="other">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <fieldset class="scheduler-border">
                                                            ...
                                                            <div class="control-group">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <label for="collected_by">ID Number and Full
                                                                            Name</label>
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                ...
                                                <p class="ml-3 d-block"><strong
                                                        style="font-weight: bold; font-size:18px;">Note : </strong> Please
                                                    enter authoriser verification pin to proceed further into the
                                                    application</p>
                                                <div class="col-lg-12">
                                                    <div>
